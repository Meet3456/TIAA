        ...
        <div className="bg-primary-100 ">
            ...
            <div className="flex items-center mt-[5%] h-screen flex flex-col">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-3 m-2 bg-primary-100">
                    ...
                    <NavLink to="http://localhost:8501"><CustomCard heading="NearMe Explorer 📍" text="Map explorer - For easy Retired Life" image={advisor} /></NavLink>
                    <NavLink to="http://localhost:8502"><CustomCard heading="Finance Bot ✅" text="Stock and Financial bot" image={healthcare} /></NavLink>
                    <NavLink to="http://localhost:8503"><CustomCard heading="Robo Advisor 🤖" text="Get Ai Advice-for Retirement Purposes" image={finance} /></NavLink>
                    <NavLink to="http://localhost:8504"><CustomCard heading="HealthCare 🩺" text="know Insurance cost." image={explorer} /></NavLink>
                </div>
            </div>
            <Footer/>
